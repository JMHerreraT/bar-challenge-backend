"""
Django settings for barchallenge project.
...
SECRET_KEY = 'django-insecure-o_%*dr7dm3*9f97#p)pc!(9^0es(@6trcq_q3!)j%3awc^wx^o'
...
WSGI_APPLICATION = 'barchallenge.wsgi.application'
